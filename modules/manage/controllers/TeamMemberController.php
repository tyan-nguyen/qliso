...
class TeamMemberController extends Controller
{
     ...
     * @return mixed
     */
    public function actionIndex($idWorking=NULL)
    {    
        $searchModel = new TeamMemberSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, $idWorking);
    ...
    /**
     * Displays a single TeamMember model (public).
     * @param integer $id
     * @return mixed
     */
            ...
            if($request->isGet){
                ...
                if($model->save()){
                    return [
                        ...
                        'title'=> "Thêm mới thành viên",
                        'content'=>'<span class="text-success">Thêm thành viên vào đoàn kiểm tra thành công!</span>',
                        'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                                Html::a('Create More',['create?idWorking=' . $idWorking],['class'=>'btn btn-primary','role'=>'modal-remote'])
    ...
    /**
     * Delete an existing TeamMember model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TeamMember model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
