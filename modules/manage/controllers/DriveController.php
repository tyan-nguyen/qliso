...
class DriveController extends Controller
{
    ...
    public function actionUpload()
    {
        ...
        $client->setClientId('222817380185-kc7v11fsdjt28b5a2kd6avmat976bq92.apps.googleusercontent.com');
        $client->setClientSecret('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');
        $client->setRedirectUri('https://dbcl.tvu.edu.vn/qliso/manage/drive/upload');
        ...
        if (isset($_GET['code']) || (isset($_SESSION['access_token']) && $_SESSION['access_token'])) {
            if (isset($_GET['code'])) {
               ...
               // echo '<br/>' . $fileModel->user->email;
                ...
                $file->setParents(['1DQ9KJyX3AmtRXEpEcwQFxoleGn0g7Lz0']);
               ...
               // echo '<br/>';
                ...
                if($fileModel->save()){
                    //echo '<br/>'. 'file save!!!!!!!!!!!!!!';
                    return $this->redirect(Yii::getAlias('@web') . '/manage/working/view?id=' . $fileModel->id_working);
