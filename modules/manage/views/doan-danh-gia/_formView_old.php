...
<div class="box box-solid">
    ...
    <div class="box-body" style="">
    	...
    	<?php /*Html::a('<i class="fa fa-plus-circle"></i> Tạo file biểu mẫu', ['file/create?idWorking=' . $model->id],
...
<div class="box box-solid">
    <div class="box-header ui-sortable-handle" style="cursor: move;">
        ...
        <div class="pull-right box-tools">
        	<?php /* Html::a('<i class="glyphicon glyphicon-plus"></i>', ['team-member/create?idWorking='.$model->id],
                        ['role'=>'modal-remote','title'=> 'Create new Team Members','class'=>'btn btn-sm']) */ ?>
            <button type="button" class="btn btn-sm" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
        </div>
    ...
    <div class="box-header ui-sortable-handle" style="cursor: move;">
        ...
        <div class="pull-right box-tools">
        	...
        	<?= Html::a('<i class="glyphicon glyphicon-plus"></i>', ['working-files/create?idWorking='.$model->id],
                        ['role'=>'modal-remote','title'=> 'Create working file','class'=>'btn btn-sm'])
                        ?>
            <button type="button" class="btn btn-sm" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
        </div>
    ...
    <div class="box-body" style="">
    	 ...
    	 <div id="ajaxCrudDatatable1">
              <?= $model->isNewRecord ? 
                ...
                'pjax'=>true,
                'columns' => require(__DIR__.'/../working-files/_columnsDoanDanhGia.php'),
                'toolbar'=> [
                    ['content'=>''
                      /*  Html::a('<i class="glyphicon glyphicon-plus"></i>', ['working-files/create?idWorking='.$model->id],
    ...
    <div class="box-header ui-sortable-handle" style="cursor: move;">
        ...
        <div class="pull-right box-tools">
        	<?php /* Html::a('<i class="glyphicon glyphicon-plus"></i>', ['document/create?idWorking='.$model->id],
                        ['role'=>'modal-remote','title'=> 'Create documents','class'=>'btn btn-sm']) */ ?>
            <button type="button" class="btn btn-sm" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
        </div>
    ...
    <div class="box-body" style="">
    	 ...
    	 <div id="ajaxCrudDatatable2">
              <?= $model->isNewRecord ? 
                ...
                'pjax'=>true,
                'columns' => require(__DIR__.'/../document/_columnsDoanDanhGia.php'),
                'toolbar'=> [
                    ['content'=>''
