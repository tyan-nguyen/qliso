...
/* @var $searchModel app\modules\manage\models\TeamPostionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Chức vụ trong đoàn kiểm tra';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="team-postion-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách chức vụ',
