...
$this->title = UserManagementModule::t('back', 'Phân quyền cho tài khoản:') . ' ' . $user->username;
...
<div class="row">
	<div class="col-sm-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?= UserManagementModule::t('back', 'Thuộc nhóm quyền') ?>
				</strong>
			</div>
	...
	<div class="col-sm-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?= UserManagementModule::t('back', 'Chức năng') ?>
				</strong>
			</div>
			<div class="panel-body">
