...
$this->title = UserManagementModule::t('back', 'Tài khoản');
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<?= GridView::widget([
				...
				'layout'=>'{summary}{items}<div class="row"><div class="col-sm-8">{pager}</div><div class="col-sm-4 text-right">'
				...
				'columns' => [
					...
					[
						'value'=>function(User $model){
								return GhostHtml::a(
									UserManagementModule::t('back', 'Đổi mật khẩu'),
