...
$config = [
    ...
    'modules' => [
    	'ksadmin' => [
    		'class' => 'app\modules\ksadmin\KsAdminModule',
    	],
    	'admin' => [
    	...
    	'surveysv' => [
    		'class' => 'app\modules\surveysv\SurveySVModule',
    	],
    	...
    	'pub' => [
    		'class' => 'app\modules\pub\PubModule',
    	],
    	'sinhvien' => [
    		'class' => 'app\modules\sinhvien\SinhVienModule',
    	],
    	'giangvien' => [
    		'class' => 'app\modules\giangvien\GiangVienModule',
    	],
    	'user-management' => [
